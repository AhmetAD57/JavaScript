...
// val='Deneme';
// val+=' Deneme1';
// val='Benim adım '+ firstname + ' '+ lastname+ ' ve yaşım '+ age+ ' denemea\'denemeb';
...
val='my name is '+ fullname+ ' I\'m '+(2018-YearOfBird)+' years old and I live in '+ city;

//ternary operator
val=`my name is ${fullname} I'm ${(2018-YearOfBird>=18) ?'over 18':'under 18'} and I live in ${city}`;
